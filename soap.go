...
type UnmarshalSOAPEnvelope struct {
	XMLName xml.Name
	Headers []interface{} `xml:"http://schemas.xmlsoap.org/soap/envelope/ Header"`
	Body    UnmarshalSOAPBody
}

type UnmarshalSOAPBody struct {
	XMLName xml.Name
...
type MarshalSOAPEnvelope struct {
	XMLName xml.Name      `xml:"S:Envelope"`
	XMLNS   string        `xml:"xmlns:S,attr"`
	Headers []interface{} `xml:"http://schemas.xmlsoap.org/soap/envelope/ Header"`
	Body    MarshalSOAPBody
}

type MarshalSOAPBody struct {
...
// UnmarshalXML unmarshals UnmarshalSOAPBody xml
func (b *UnmarshalSOAPBody) UnmarshalXML(d *xml.Decoder, _ xml.StartElement) error {
	if b.Content == nil {
...
func (s *Client) call(ctx context.Context, soapAction string, request, response interface{}) error {
	...
	respEnvelope := new(UnmarshalSOAPEnvelope)
	respEnvelope.Body = UnmarshalSOAPBody{Content: response}
